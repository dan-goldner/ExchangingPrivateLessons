...
public data class LessonDetailsFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): LessonDetailsFragmentArgs {
      bundle.setClassLoader(LessonDetailsFragmentArgs::class.java.classLoader)
      ...
      return LessonDetailsFragmentArgs(__lessonId)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): LessonDetailsFragmentArgs {
      val __lessonId : String?
